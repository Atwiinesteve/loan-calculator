...
// Add Click Event on the Button to Calculate the amounts and draw graph.
...
function chart(principal, interest, monthly, payments) {
    ...
    let graph = document.querySelector("#graph"); // Get the <canvas> tag
    ...
    let width = graph.width; // Get the canvas width.
    let height = graph.height; // Get canvas height.
    ...
    let ticks = [monthly*payments, principal]; // The two points we'll mark
